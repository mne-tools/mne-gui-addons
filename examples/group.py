...
============================================================
Group-Level Volume Source Time Course Estimate Visualization
============================================================

In this example, we'll view the source time course estimates (STCs)
for a group of subjects so that we can compare and contrast.
"""
